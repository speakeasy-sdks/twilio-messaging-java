...
public class DeleteShortCodeSecurity {
    @SpeakeasyMetadata("security:scheme=true,type=http,subtype=basic,name=password")
    public String password;

    public DeleteShortCodeSecurity withPassword(String password) {
    ...
    public DeleteShortCodeSecurity withUsername(String username) {
        this.username = username;
        return this;
    }
    
    public DeleteShortCodeSecurity(@JsonProperty("Username") String username, @JsonProperty("Password") String password) {
        this.username = username;
        this.password = password;
  }
}
