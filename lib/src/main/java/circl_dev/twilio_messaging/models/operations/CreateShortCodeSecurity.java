...
public class CreateShortCodeSecurity {
    ...
    public CreateShortCodeSecurity withPassword(String password) {
    ...
    public CreateShortCodeSecurity withUsername(String username) {
        this.username = username;
        return this;
    }
    
    public CreateShortCodeSecurity(@JsonProperty("Username") String username, @JsonProperty("Password") String password) {
        this.username = username;
        this.password = password;
  }
}
