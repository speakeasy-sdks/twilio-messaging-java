...
public class FetchUsecaseSecurity {
    ...
    public FetchUsecaseSecurity withPassword(String password) {
    ...
    public FetchUsecaseSecurity withUsername(String username) {
        this.username = username;
        return this;
    }
    
    public FetchUsecaseSecurity(@JsonProperty("Username") String username, @JsonProperty("Password") String password) {
        this.username = username;
        this.password = password;
  }
}
