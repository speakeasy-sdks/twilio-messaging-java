...
public class CreateServiceCreateServiceRequest1 {
    ...
    public CreateServiceCreateServiceRequest1 withAreaCodeGeomatch(Boolean areaCodeGeomatch) {
    ...
    public CreateServiceCreateServiceRequestFallbackMethod fallbackMethod;

    public CreateServiceCreateServiceRequest1 withFallbackMethod(CreateServiceCreateServiceRequestFallbackMethod fallbackMethod) {
    ...
    public CreateServiceCreateServiceRequest1 withFallbackToLongCode(Boolean fallbackToLongCode) {
    ...
    public CreateServiceCreateServiceRequest1 withFallbackUrl(String fallbackUrl) {
    ...
    public CreateServiceCreateServiceRequest1 withFriendlyName(String friendlyName) {
    ...
    public CreateServiceCreateServiceRequestInboundMethod inboundMethod;

    public CreateServiceCreateServiceRequest1 withInboundMethod(CreateServiceCreateServiceRequestInboundMethod inboundMethod) {
    ...
    public CreateServiceCreateServiceRequest1 withInboundRequestUrl(String inboundRequestUrl) {
    ...
    public CreateServiceCreateServiceRequest1 withMmsConverter(Boolean mmsConverter) {
    ...
    public CreateServiceCreateServiceRequest1 withScanMessageContent(circl_dev.twilio_messaging.models.shared.ServiceEnumScanMessageContent scanMessageContent) {
    ...
    public CreateServiceCreateServiceRequest1 withSmartEncoding(Boolean smartEncoding) {
    ...
    public CreateServiceCreateServiceRequest1 withStatusCallback(String statusCallback) {
    ...
    public CreateServiceCreateServiceRequest1 withStickySender(Boolean stickySender) {
    ...
    public CreateServiceCreateServiceRequest1 withSynchronousValidation(Boolean synchronousValidation) {
    ...
    public CreateServiceCreateServiceRequest1 withUseInboundWebhookOnNumber(Boolean useInboundWebhookOnNumber) {
    ...
    public CreateServiceCreateServiceRequest1 withUsecase(String usecase) {
    ...
    public CreateServiceCreateServiceRequest1 withValidityPeriod(Long validityPeriod) {
        this.validityPeriod = validityPeriod;
        return this;
    }
    
    public CreateServiceCreateServiceRequest1(@JsonProperty("FriendlyName") String friendlyName) {
        this.friendlyName = friendlyName;
  }
}
